...
const bluePixelPNG = Buffer.from([
  ...
  0x54, 0x08, 0x99, 0x63, 0x60, 0x64, 0xf8, 0x0f,
  0x00, 0x00, 0x01, 0x01, 0x00, 0x01, 0x0a, 0xdd,
  0x3b, 0x5e, 0x00, 0x00, 0x00, 0x00, 0x49, 0x45,
...
placeholders.forEach(placeholder => {
  ...
  console.log(`Created placeholder: ${placeholder.name} (${placeholder.description})`);
});
