...
- **Simultaneous Backdrop & Dialog Animation**: The dark tint on the "Add New Place" modal now fades in/out simultaneously with the dialog slide, using a single shared animation value — backdrop no longer disappears before the dialog closes
