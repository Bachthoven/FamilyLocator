            ...
            <div className="flex gap-2 overflow-x-auto pb-2">
              ...
              {familyMembers.map(([userId, data]) => (
                <Button
                  key={userId}
                  variant={
                    selectedMember === parseInt(userId) ? "default" : "outline"
                  }
                  size="sm"
                  ...
                  style={{
                    borderColor:
                      selectedMember === parseInt(userId)
                        ? getColorForUser(parseInt(userId))
                        : undefined,
                    backgroundColor:
                      selectedMember === parseInt(userId)
                        ? getColorForUser(parseInt(userId))
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-muted-foreground text-center">
                Location history will appear here once family members start
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <CardDescription>
                            {data.locations.length} locations in the past 24
                            hours
                          </CardDescription>
                        </div>
                      </div>
