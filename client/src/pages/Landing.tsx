      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          <div className="mb-8">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-4 text-primary dark:text-primary leading-tight py-2">
              FamilyLocator
            </h1>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
              Stay connected with your loved ones. Share your location securely
              and keep your family safe with real-time location tracking.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <Card className="text-center p-6 relative">
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground mb-4">
                  ...
                  account; if you already have one, you'll sign right in. Takes
                  seconds with secure email authentication.
                </p>
                <div className="bg-green-50 dark:bg-green-900/20 p-3 rounded-lg text-sm">
                  <strong>That's it!</strong> New or returning, you're instantly
            ...
            <Card className="text-center p-6 relative">
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground">
                  Send this website link to your family members so they can
                  create their own accounts the same way you did.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center p-6 relative">
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground mb-4">
                  Once everyone has accounts, invite each other through the
                  Family tab and start sharing locations safely.
                </p>
                <div className="bg-purple-50 dark:bg-purple-900/20 p-3 rounded-lg text-sm">
                  <strong>Important:</strong> Everyone needs their own account
